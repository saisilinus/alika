...
export default function AdminDashboard() {
  ...
  const [deleteCampaign, { isLoading: deleteLoading }] =
    useDeleteCampaignMutation();
  const [updateUserRole, { isLoading: roleUpdateLoading }] =
    useUpdateUserRoleMutation();
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      +{stats?.monthlyGrowth?.users || 0}% from last month
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      +{stats?.monthlyGrowth?.campaigns || 0}% from last month
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      +{stats?.monthlyGrowth?.views || 0}% from last month
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      +{stats?.monthlyGrowth?.downloads || 0}% from last month
                    </p>
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    User registrations and campaign creations
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {statsLoading ? (
              ...
              >
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Add a new campaign to the platform
                    </DialogDescription>
                  </DialogHeader>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Views and downloads by category
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {statsLoading ? (
