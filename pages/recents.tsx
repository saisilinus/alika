...
const banners = [
  {
    ...
    description:
      'Join us for an unforgettable summer music experience with top artists from around the world.',
    thumbnail:
  ...
  },
  {
    ...
    description:
      'Discover the latest in AI, blockchain, and emerging technologies with industry leaders.',
    thumbnail:
  ...
  },
  {
    ...
    description:
      'Help us raise funds for clean water access in underserved communities worldwide.',
    thumbnail:
    ...
    creator: {
      name: 'WaterAid',
      avatar:
        'https://images.unsplash.com/photo-1494790108755-2616b332c6ab?w=100&h=100&fit=crop&crop=face',
    },
  },
  {
    id: 4,
    ...
    description:
      'Taste amazing local cuisine from the best restaurants and food trucks in the city.',
    thumbnail:
  ...
  },
  {
    ...
    description:
      'Experience contemporary art from emerging artists in our new downtown gallery space.',
    thumbnail:
  ...
  },
  {
    ...
    description:
      'Connect with entrepreneurs and business leaders in our monthly networking meetup.',
    thumbnail:
...
const handleCardClick = (bannerId: number) => {
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            <Avatar className="h-6 w-6">
                              <AvatarImage
                                src={
                                  banner.creator.avatar || '/placeholder.svg'
                                }
                              />
                              <AvatarFallback>
