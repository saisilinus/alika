      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center bg-blue-500/20 px-4 py-2 rounded-full text-sm font-medium mb-4">
            <Rocket className="mr-2 h-4 w-4" /> Welcome to the future of
            campaigns
          </div>
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
            Everything you need to build<br></br> unstoppable momentum for your
            campaign or event
          </p>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        <Avatar className="h-6 w-6">
                          <AvatarImage
                            src={banner.creator?.image || "/placeholder.svg"}
                          />
                          <AvatarFallback>
                            {banner.creator?.name?.[0] || "U"}
                          </AvatarFallback>
                        </Avatar>
                        <span className="text-sm text-gray-600">
                          {banner.creator?.name || "Creator"}
                        </span>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Create stunning dp banners for your campaigns & events in just a
              few simple steps
            </p>
          </div>
