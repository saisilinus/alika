...
import { Eye, Calendar, ArrowRight, Search, Menu, X } from 'lucide-react';
...
const CategoriesPage = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      name: 'Film',
      image:
        'https://images.unsplash.com/photo-1489599242320-69c5ad6f1c02?w=400&h=300&fit=crop',
      count: 78,
    },
    {
      id: 9,
  ...
  const [user, setUser] = useState<User>({
    name: 'John Doe',
    image: '/hero.jpg?height=32&width=32',
    role: 'user',
    email: '',
    isActive: true,
  });
  ...
  const handleLogout = () => {
    setIsLoggedIn(false);
    setUser({ name: '', image: '', role: 'user', email: '', isActive: true });
  };
      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20 lg:py-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-100">
            Discover campaigns and events by category
          </p>
        </div>
      </section>
