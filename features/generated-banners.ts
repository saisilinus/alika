...
const generatedBannerApi = apiWithGeneratedBannerTags.injectEndpoints({
  endpoints: (builder) => ({
    getGeneratedBanners: builder.query<
      GeneratedBannerResponse,
    ...
    getGeneratedBannerById: builder.query<GeneratedBanner, string>({
      ...
      providesTags: (result) =>
        result
          ? [{ type: "GeneratedBanner", id: result._id as unknown as string }]
          : ["GeneratedBanner"],
    }),

    getUserGeneratedBanners: builder.query<
      GeneratedBannerResponse,
    ...
    updateGeneratedBanner: builder.mutation<
      { success: boolean },
      UpdateGeneratedBannerRequest
    >({
    ...
    downloadGeneratedBanner: builder.mutation<
